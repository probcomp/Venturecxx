...
function InitializeDemo() {
    ...
    var CheckModelVariables = function() {
        ...
        if ( getEnumRequested() &&  getSliceRequested() && getNesterovCycleRequested()) {
            inference_program = "(cycle ((mh default one 5) (gibbs structure one 1) (slice params one 1) (nesterov default all 0.1 5 1)) 1)";
        }
        if (!getEnumRequested() &&  getSliceRequested() && getNesterovCycleRequested()) {
            inference_program = "(cycle ((mh default one 5) (slice params one 1) (nesterov default all 0.1 5 1)) 1)";
        }
        if ( getEnumRequested() && !getSliceRequested() && getNesterovCycleRequested()) {

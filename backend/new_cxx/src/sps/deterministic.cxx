...
VentureValuePtr AtomOutputPSP::simulate(shared_ptr<Args> args, gsl_rng * rng) const
{
...
VentureValuePtr IntegerOutputPSP::simulate(shared_ptr<Args> args, gsl_rng * rng) const
{

...
registerBuiltinSP("sub", binaryNum(lambda x,y: x - y,
...
registerBuiltinSP("int_div",   binaryNum(lambda x,y: raise_(VentureValueError("division by zero")) if int(y) == 0 else int(x) // int(y),
                                    descr="div returns the integer quotient of its first argument by its second") )

registerBuiltinSP("int_mod",   binaryNum(lambda x,y: raise_(VentureValueError("modulo by zero")) if int(y) == 0 else int(x) % int(y),
                                    descr="mod returns the modulus of its first argument by its second") )

registerBuiltinSP("min",   binaryNum(min, descr="min returns the minimum value of its arguments") )
...
registerBuiltinSP("floor", unaryNum(math.floor, sim_grad=zero_gradient, descr="floor returns the largest integer less than or equal to its argument (as a VentureNumber)") )

           # Only makes sense with VentureAtom/VentureNumber distinction
registerBuiltinSP("real",  deterministic_typed(lambda x:x, [t.AtomType()], t.NumberType(),
                                          descr="real returns the identity of its argument atom as a number"))
registerBuiltinSP("atom_eq", deterministic_typed(lambda x,y: x == y, [t.AtomType(), t.AtomType()], t.BoolType(),
...
registerBuiltinSP("probability",  deterministic_typed(lambda x:x, [t.ProbabilityType()], t.ProbabilityType(),
...
registerBuiltinSP("exp", unaryNum(careful_exp, sim_grad=lambda args, direction: [direction * careful_exp(args[0])], descr="Returns the exp of its argument"))
...
registerBuiltinSP("pow", binaryNum(math.pow, sim_grad=grad_pow, descr="pow returns its first argument raised to the power of its second argument"))
...
registerBuiltinSP("negate", unaryNum(lambda x: -x,
                                sim_grad=grad_negate,
                                descr="negate(x) returns -x, the additive inverse of x."))

registerBuiltinSP("abs", unaryNum(abs,
                             sim_grad=grad_abs,
...
registerBuiltinSP("second", deterministic_typed(lambda p: p[1][0], [t.PairType(second_type=t.PairType())], t.AnyType(),
...
registerBuiltinSP("to_list", deterministic_typed(lambda seq: seq.asPythonList(), [t.HomogeneousSequenceType(t.AnyType())], t.HomogeneousListType(t.AnyType()),
                                            descr="to_list converts its argument sequence to a list"))


registerBuiltinSP("array", deterministic_typed(lambda *args: np.array(args), [t.AnyType()], t.ArrayType(), variadic=True,
                                          sim_grad=lambda args, direction: direction.getArray(),
                                          descr="array returns an array initialized with its arguments"))

registerBuiltinSP("vector", deterministic_typed(lambda *args: np.array(args), [t.NumberType()], t.ArrayUnboxedType(t.NumberType()), variadic=True,
                                          sim_grad=lambda args, direction: direction.getArray(),
...
registerBuiltinSP("to_array", deterministic_typed(lambda seq: seq.getArray(), [t.HomogeneousSequenceType(t.AnyType())], t.ArrayType(),
                                             descr="to_array converts its argument sequence to an array"))
registerBuiltinSP("to_vector", deterministic_typed(lambda seq: np.array(seq.getArray(t.NumberType())), [t.HomogeneousSequenceType(t.NumberType())], t.ArrayUnboxedType(t.NumberType()),
                                             descr="to_vector converts its argument sequence to a vector"))

registerBuiltinSP("dict", deterministic_typed(lambda keys, vals: dict(zip(keys, vals)),
...
registerBuiltinSP("matrix", deterministic_typed(np.array,
...
registerBuiltinSP("simplex", deterministic_typed(lambda *nums: np.array(nums), [t.ProbabilityType()], t.SimplexType(), variadic=True,
...
registerBuiltinSP("binomial", typed_nr(discrete.BinomialOutputPSP(), [t.CountType(), t.ProbabilityType()], t.CountType()))
registerBuiltinSP("flip", typed_nr(discrete.BernoulliOutputPSP(), [t.ProbabilityType()], t.BoolType(), min_req_args=0))
registerBuiltinSP("bernoulli", typed_nr(discrete.BernoulliOutputPSP(), [t.ProbabilityType()], t.IntegerType(), min_req_args=0))
registerBuiltinSP("log_flip", typed_nr(discrete.LogBernoulliOutputPSP(), [t.NumberType()], t.BoolType()))
registerBuiltinSP("log_bernoulli", typed_nr(discrete.LogBernoulliOutputPSP(), [t.NumberType()], t.BoolType()))
registerBuiltinSP("categorical", typed_nr(discrete.CategoricalOutputPSP(), [t.SimplexType(), t.ArrayType()], t.AnyType(), min_req_args=1))
registerBuiltinSP("uniform_discrete", typed_nr(discrete.UniformDiscreteOutputPSP(), [t.IntegerType(), t.IntegerType()], t.IntegerType()))
...
registerBuiltinSP("vonmises", typed_nr(continuous.VonMisesOutputPSP(), [t.NumberType(), t.PositiveType()], t.NumberType()))
registerBuiltinSP("uniform_continuous",typed_nr(continuous.UniformOutputPSP(), [t.NumberType(), t.NumberType()], t.NumberType()))
registerBuiltinSP("beta", typed_nr(continuous.BetaOutputPSP(), [t.PositiveType(), t.PositiveType()], t.ProbabilityType()))
registerBuiltinSP("expon", typed_nr(continuous.ExponOutputPSP(), [t.PositiveType()], t.PositiveType()))
registerBuiltinSP("gamma", typed_nr(continuous.GammaOutputPSP(), [t.PositiveType(), t.PositiveType()], t.PositiveType()))
registerBuiltinSP("student_t", typed_nr(continuous.StudentTOutputPSP(), [t.PositiveType(), t.NumberType(), t.NumberType()], t.NumberType(), min_req_args=1 ))
registerBuiltinSP("inv_gamma", typed_nr(continuous.InvGammaOutputPSP(), [t.PositiveType(), t.PositiveType()], t.PositiveType()))
registerBuiltinSP("laplace", typed_nr(continuous.LaplaceOutputPSP(), [t.NumberType(), t.PositiveType()], t.NumberType()))

registerBuiltinSP("multivariate_normal", typed_nr(continuous.MVNormalOutputPSP(), [t.HomogeneousArrayType(t.NumberType()), t.SymmetricMatrixType()], t.HomogeneousArrayType(t.NumberType())))
registerBuiltinSP("inv_wishart", typed_nr(continuous.InverseWishartPSP(), [t.SymmetricMatrixType(), t.PositiveType()], t.SymmetricMatrixType()))
registerBuiltinSP("wishart", typed_nr(continuous.WishartPSP(), [t.SymmetricMatrixType(), t.PositiveType()], t.SymmetricMatrixType()))

registerBuiltinSP("make_beta_bernoulli",typed_nr(discrete.MakerCBetaBernoulliOutputPSP(), [t.PositiveType(), t.PositiveType()], SPType([], t.BoolType())))
registerBuiltinSP("make_uc_beta_bernoulli",typed_nr(discrete.MakerUBetaBernoulliOutputPSP(), [t.PositiveType(), t.PositiveType()], SPType([], t.BoolType())))
registerBuiltinSP("make_suff_stat_bernoulli",typed_nr(discrete.MakerSuffBernoulliOutputPSP(), [t.NumberType()], SPType([], t.BoolType())))

registerBuiltinSP("dirichlet",typed_nr(dirichlet.DirichletOutputPSP(), [t.HomogeneousArrayType(t.PositiveType())], t.SimplexType()))
registerBuiltinSP("symmetric_dirichlet",typed_nr(dirichlet.SymmetricDirichletOutputPSP(), [t.PositiveType(), t.CountType()], t.SimplexType()))

registerBuiltinSP("make_dir_mult",typed_nr(dirichlet.MakerCDirMultOutputPSP(), [t.HomogeneousArrayType(t.PositiveType()), t.ArrayType()], SPType([], t.AnyType()), min_req_args=1))
registerBuiltinSP("make_uc_dir_mult",typed_nr(dirichlet.MakerUDirMultOutputPSP(), [t.HomogeneousArrayType(t.PositiveType()), t.ArrayType()], SPType([], t.AnyType()), min_req_args=1))

registerBuiltinSP("make_sym_dir_mult",typed_nr(dirichlet.MakerCSymDirMultOutputPSP(), [t.PositiveType(), t.CountType(), t.ArrayType()], SPType([], t.AnyType()), min_req_args=2)) # Saying AnyType here requires the underlying psp to emit a VentureValue.
registerBuiltinSP("make_uc_sym_dir_mult",typed_nr(dirichlet.MakerUSymDirMultOutputPSP(), [t.PositiveType(), t.CountType(), t.ArrayType()], SPType([], t.AnyType()), min_req_args=2))

registerBuiltinSP("make_crp",typed_nr(crp.MakeCRPOutputPSP(), [t.NumberType(),t.NumberType()], SPType([], t.AtomType()), min_req_args = 1))
registerBuiltinSP("make_cmvn",typed_nr(cmvn.MakeCMVNOutputPSP(),
                                  [t.HomogeneousArrayType(t.NumberType()),t.NumberType(),t.NumberType(),t.MatrixType()],
                                  SPType([], t.HomogeneousArrayType(t.NumberType()))))

registerBuiltinSP("make_lazy_hmm",typed_nr(hmm.MakeUncollapsedHMMOutputPSP(), [t.SimplexType(), t.MatrixType(), t.MatrixType()], SPType([t.CountType()], t.AtomType())))
registerBuiltinSP("make_gp", gp.makeGPSP)
registerBuiltinSP("apply_function", function.applyFunctionSP)
registerBuiltinSP("exactly", typed_nr(discrete.ExactlyOutputPSP(), [t.AnyType(), t.NumberType()], t.AnyType(), min_req_args=1))
registerBuiltinSP("value_error", deterministic_typed(lambda s: raise_(VentureValueError(str(s))), [t.AnyType()], t.AnyType()))
